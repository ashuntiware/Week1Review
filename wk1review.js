...
let text = 'Sabrina';
let ltter = text.charAt(5);


// Define Unicode in a comment, and get the Unicode using charCodeAt() of the third character in Teddy

//Unicode is a universal character that defines a list of many other characters.
...
let text = String.fromCharCode(3);

// Take yourr first and last name and concat()
const arr1 = ['Ashunti'];
const arr2 = ['Ware'];  
const myName = arr1.concat(arr2);       
...
// concat() merges all the arrays (and non-array arguments) into a single array
